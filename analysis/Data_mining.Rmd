...
```{r, include = FALSE, echo = FALSE}
meta_look <- readRDS(file = "../datamine_results/full_combined_matrix.rds")
...
knitr::include_graphics("../datamine_results/boxcox_bin_pca_case.png")
```
...
knitr::include_graphics("../datamine_results/boxcox_bin_pca_sex.png")
```
...
knitr::include_graphics("../datamine_results/boxcox_bin_heatmap_top50.png")
```


# Analysis Strategy

```{r, fig.cap = "Our cross-validation setup for Random Forest."}
knitr::include_graphics("../datamine_results/Standard_5CV.png")
```
...
source("dm_03_model_eval.R")
final_table <- read.csv("../datamine_results/pooled_summaries_all_scenarios.csv") 

fold_table <- read.csv("../datamine_results/fold-summaries.csv") 
...
knitr::include_graphics("../datamine_results/bc_only_pooledROC.png")
```
...
```{r, fig.cap="Cross-validated receiver operating characteristic (ROC) curves for four models classifying JMML versus control using metabolomic features. The solid curves show the pooled ROC for Logistic Regression (green), Support Vector Machine (orange), Random Forest (blue), and XGBoost (magenta). The dashed diagonal line represents random-chance performance (AUC = 0.5)."}
knitr::include_graphics("../datamine_results/bc_bin_pooledROC.png")
```
...
```{r, fig.cap="Cross-validated receiver operating characteristic (ROC) curves for four models classifying JMML versus control using metabolomic features. The solid curves show the pooled ROC for Logistic Regression (green), Support Vector Machine (orange), Random Forest (blue), and XGBoost (magenta). The dashed diagonal line represents random-chance performance (AUC = 0.5)."}
knitr::include_graphics("../datamine_results/bc_meta_pooledROC.png")
```
...
```{r, fig.cap="Cross-validated receiver operating characteristic (ROC) curves for four models classifying JMML versus control using metabolomic features. The solid curves show the pooled ROC for Logistic Regression (green), Support Vector Machine (orange), Random Forest (blue), and XGBoost (magenta). The dashed diagonal line represents random-chance performance (AUC = 0.5)."}
knitr::include_graphics("../datamine_results/bc_bin_meta_pooledROC.png")
```
...
```{r}
limma_results_boxcox_bin <- read.csv("../datamine_results/ranked_metabolites_combined.csv")
...
knitr::include_graphics("../datamine_results/combined_rf_oob_importance.png")
```
