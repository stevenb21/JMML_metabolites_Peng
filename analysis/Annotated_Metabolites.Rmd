...
```{r, echo=FALSE, results='asis', warning=FALSE}
script <- "../01_annotated/03_QLIC_imputation.R"
...
source("pathway.R")
pathway <- read_csv("../results/pathway_results.csv")
...
```{r, include = FALSE}
source("Consistency_scatterplot.R")
```
...
source("06b_Somatic_analysis_viz.R")
```
